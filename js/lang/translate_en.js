var translate_en = {
    ...
    e502:'Download PC client',
    e503:'Foxlet web client',
    r201:'RippleFox',
    ...
    r401:'Auto deposit/withdraw via Foxlet client.',
    ...
    foxlet1: 'Foxlet Wallet',
    foxlet2: 'Foxlet allows you to encrypt your mnemonic/secret key and store it as a file locally on your computer. So your account is as safe as the security of your personal computer.',
    foxlet3: 'The wallet is open source, you can compile it yourself.',
    foxlet4: 'An easier way is to visit the web version.',
    foxlet11: 'You can easily trust the asset in "Gateways" menu of Foxlet client.',
    foxlet12: 'Back to the balance page, in the corresponding currency, you can see the "Deposit" menu, click to generate a deposit address.',
    foxlet21: 'In the balance page, find the corresponding currency, you can see the "Withdraw" menu, click to jump to the "Send" page.',
    foxlet22: 'The page is generated using a special payment protocol, fill in the withdrawal address and amount.',
    foxlet23: 'The withdrawal fee is 0.2%, and the withdrawal will be completed after sending. If not received within 24 hours, please contact support@ripplefox.com',
    foxlet24: 'When using RippleAPI to withdraw, the following memos must be provided.',
    eth_trust : 'You cannot deposit unless you trust "ETH" of "rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y".',
    usd_trust : 'You cannot deposit unless you trust "USD" of "rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y". Note: The code is USD, not USDT.',
    s201:'RippleFox',
